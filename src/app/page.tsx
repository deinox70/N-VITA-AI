...
export default function Home() {
  ...
  return (
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      {/* Header */}
      <header className="flex items-center justify-between px-8 py-5 border-b border-[#1c2b1e] backdrop-blur-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-lg font-bold text-[#e4f0e6] leading-none" style={{ fontFamily: 'DM Serif Display, serif' }}>
        ...
        <div className="w-full max-w-xl">
          ...
          <div className="text-center mb-10 fade-up">
            <div className="inline-flex items-center gap-2 bg-[#3ddc84]/10 border border-[#3ddc84]/20 rounded-full px-4 py-1.5 mb-5">
              <span className="text-xs text-[#3ddc84] font-bold tracking-widest uppercase">Free · No API · Instant Results</span>
            </div>
            ...
            <p className="text-[#6b8f6e] text-base leading-relaxed max-w-sm mx-auto">
              Upload any blood test or health report PDF and get instant disease risk analysis with personalised recommendations.
            </p>
          </div>
          ...
          <div className="bg-[#0f1711] border border-[#1c2b1e] rounded-2xl p-7 shadow-2xl fade-up d1">
            ...
            >
              ...
              {file ? (
                ...
                <div>
                  <div className="text-5xl mb-3">📂</div>
                  <p className="text-[#e4f0e6] font-semibold mb-1">Drop your health report PDF here</p>
                  <p className="text-[#6b8f6e] text-sm mb-3">Blood test · Lipid panel · Thyroid · Full body check-up</p>
            ...
            <button
              ...
              className="w-full py-4 rounded-xl font-bold text-[#080d0b] text-base tracking-wide transition-all duration-300 disabled:opacity-40 disabled:cursor-not-allowed hover:opacity-90 active:scale-[0.99]"
              style={{ background: 'linear-gradient(135deg, #3ddc84, #00b894)' }}
            >
              {loading ? (
